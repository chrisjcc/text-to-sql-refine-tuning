...
from src.evaluation.metrics import SQLMetrics, ExecutionMetrics
...
class SQLEvaluator:
    ...
    def evaluate_dataset(
        ...
        **generation_kwargs
        ...
        for i, (pred, ref, item) in enumerate(tqdm(
            zip(predictions, references, dataset),
            total=len(dataset),
    ...
    def _compute_sample_metrics(
        ...
        metrics_dict['structural_similarity'] = self.metrics.structural_similarity(predicted, reference)
        ...
        metrics_dict['complexity_match'] = pred_complexity['complexity_level'] == ref_complexity['complexity_level']
